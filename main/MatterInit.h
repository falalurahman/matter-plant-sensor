...
public:
  ...
  // Friend class for MatterSoilSensor
...
#if !defined(NO_GLOBAL_INSTANCES) && !defined(NO_GLOBAL_MATTER_INIT)
extern ArduinoMatterInit MatterInit;
#endif
